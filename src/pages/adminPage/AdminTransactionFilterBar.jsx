...
const AdminTransactionFilterBar = ({ dashboard = false, detailpage = false, onFilterChange }) => {
    const { getVendorsName, getEmployeesName } = useAuth();
    ...
    }, [selectedVendors, selectedEmployees, fromDate, toDate,onFilterChange]);
...
export default AdminTransactionFilterBar;
